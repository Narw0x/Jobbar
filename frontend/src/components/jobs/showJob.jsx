    ...
    return(
        <div className="lg:basis-2/3 w-full">
            ...
            <div className="flex flex-row mt-4 lg:w-[50%] justify-between">
                <h3 className="text-xl text-custom_gray">Field:</h3>   
                <p className="text-xl text-custom_gray align-middle mt-auto">{job.field}</p>
            </div>  
            ...
            <div className="flex flex-col mt-4 lg:w-96 mb-4">
