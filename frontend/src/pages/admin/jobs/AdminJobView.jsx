    ...
    return (
        <section className="bg-custom_bg_gray py-8">
            ...
            <Helmet>
                ...
                <meta name="description" content="Jobbar - Job Offer" />
                <meta name="keywords" content="Jobbar, Job Offer" />
            ...
            <div className="max-w-[1440px] md:w-[70%] w-[90%] flex flex-col mx-auto border rounded-lg shadow-md bg-white">
                ...
                <div className="flex flex-row px-8 py-8 gap-4">
                    <AdminNavigationButtons route={`/xyz/jobs`} btnText={'Back'} secondBtnText={'View company Profile'} secoundRoute={`/xyz/users/${job.companyId._id}`}/>
                </div>
            </div>
        </section>
